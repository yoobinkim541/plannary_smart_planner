(function () {
    ...
    window.PlanaryI18nDict.ko = {
        ...
        cancel: '취소', taskUpdated: '작업이 수정되었습니다.', noNotes: '메모 없음', dueToday: '오늘 마감', overdue: '기한 초과', priorityLabel: '우선순위',
        ...
        openSubpage: '하위 페이지 열기', loginFirst: '먼저 로그인해주세요', failedCreatePage: '페이지 생성 실패', loadFailed: '불러오기 실패', pageNotFound: '페이지를 찾을 수 없습니다',
        parentPage: '상위 페이지',
        ...
        appUpdateAvailable: '앱이 업데이트되었습니다 — 최신 버전을 사용하려면 새로고침하세요'
    };
})();
